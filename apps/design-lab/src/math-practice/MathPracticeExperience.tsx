...
export function MathPracticeExperience({
  ...
  const isInlineVisualSlots = question != null && ["N08", "P03", "P04", "C01", "C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14", "C15"].includes(question.typeId);
  const isNumberBoxAnswer = question != null && ["N06", "N07"].includes(question.typeId);
