...
export const DEFAULT_MATH_PRACTICE_SETTINGS: MathPracticeSettings = {
  ...
  arithmeticItemsPerQuestion: Object.fromEntries(["C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14", "C15"].map((typeId) => [typeId, 5])),
};
...
export const MATH_PRACTICE_PRESETS = [
  { id: "balanced", name: "综合均衡", description: "数感、计算、看图、应用和空间都会练到", typeIds: ["N01", "N04", "P01", "C07", "C02", "V01", "V04", "W01", "W03", "S04"] },
  { id: "number-sense", name: "数感数序", description: "数数、顺序、相邻数、比较和数位", typeIds: ["N01", "N02", "N03", "N04", "N05", "N06", "N07", "N08", "N15", "N16", "P01", "P05"] },
  { id: "calculation", name: "计算专项", description: "加减法、连加连减、填符号和分与合", typeIds: ["C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14", "C15", "C02", "C03", "C04", "C05", "C06", "V01", "V02", "V03", "V04"] },
