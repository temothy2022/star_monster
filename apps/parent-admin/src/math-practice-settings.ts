...
export const DEFAULT_MATH_PRACTICE_SETTINGS: MathPracticeSettings = {
  ...
  arithmeticItemsPerQuestion: Object.fromEntries(["C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14"].map((typeId) => [typeId, 5])),
};
...
export const MATH_PRACTICE_PRESETS = [
  ...
  { id: "calculation", name: "计算专项", description: "加减法、连加连减、填符号和分与合", typeIds: ["C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14", "C02", "C03", "C04", "C05", "C06", "V01", "V02", "V03", "V04"] },
