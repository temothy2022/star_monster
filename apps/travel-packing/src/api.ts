...
export const parentApi = {
  travelPackingWorkspace: () => api<TravelPackingWorkspace>("/api/parent/travel-packing-workspace"),
  createTravelPackingList: (title: string, sourceId: string | null) => api<{ list: TravelPackingList; workspace: TravelPackingWorkspace }>("/api/parent/travel-packing-lists", { method: "POST", body: JSON.stringify({ title, sourceId }) }),
