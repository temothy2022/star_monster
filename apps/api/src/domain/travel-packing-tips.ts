...
export const FAMILY_TRAVEL_PACKING_TIPS: PackingTipTemplate[] = [
  ...
  { id: "snacks", category: "孩子随身用品", label: "孩子常吃的零食", priority: "RECOMMENDED", keywords: ["零食", "饼干", "小面包", "果泥", "辅食", "奶粉"] },
  ...
  { id: "comfort-item", category: "孩子随身用品", label: "安抚玩具或绘本", priority: "RECOMMENDED", keywords: ["安抚玩具", "玩具", "绘本", "故事书", "安抚巾", "毛绒玩具"] },
  ...
  { id: "fever-medicine", category: "药品与急救", label: "儿童退烧药", priority: "ESSENTIAL", keywords: ["儿童退烧药", "退烧药", "退热药", "布洛芬", "对乙酰氨基酚", "美林", "泰诺林"] },
  { id: "thermometer", category: "药品与急救", label: "体温计", priority: "ESSENTIAL", keywords: ["体温计", "温度计", "额温枪", "耳温枪"] },
  { id: "bandages", category: "药品与急救", label: "创可贴和纱布", priority: "ESSENTIAL", keywords: ["创可贴", "创口贴", "纱布", "绷带"] },
  { id: "disinfectant", category: "药品与急救", label: "碘伏或消毒棉签", priority: "ESSENTIAL", keywords: ["碘伏", "消毒棉签", "酒精棉片", "消毒液"] },
  { id: "allergy-medicine", category: "药品与急救", label: "儿童抗过敏药", priority: "RECOMMENDED", keywords: ["抗过敏药", "过敏药", "西替利嗪", "氯雷他定"] },
  ...
  { id: "prescription", category: "药品与急救", label: "孩子日常处方药", priority: "ESSENTIAL", keywords: ["处方药", "日常药", "常用药", "长期用药"] },
  ...
  { id: "sanitizer", category: "衣物与洗护", label: "免洗洗手液", priority: "RECOMMENDED", keywords: ["洗手液", "免洗洗手液", "消毒凝胶"] },
  ...
  { id: "phone", category: "电子设备", label: "手机", priority: "ESSENTIAL", keywords: ["手机", "电话"] },
...
export function checkFamilyTravelPacking(items: PackingItemForTips[], today = new Date().toISOString().slice(0, 10)) {
  const attention = FAMILY_TRAVEL_PACKING_TIPS.flatMap((template) => {
    ...
    if (matched.some((item) => item.expirationDate && item.expirationDate < today)) status = "EXPIRED";
    else if (matched.some((item) => item.quantity === 0)) status = "OUT_OF_STOCK";
    else if (matched.length > 0) status = "UNPACKED";
