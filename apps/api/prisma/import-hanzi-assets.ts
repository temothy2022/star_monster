...
if (!manifestFile) {
  console.error("Missing --manifest. Example: pnpm --filter @star-monsters/api exec tsx prisma/import-hanzi-assets.ts --manifest packages/assets/generated/hanzi-assets/manifest.json --public-base-url https://timothy.run/hanzi-assets/v1");
  process.exit(1);
}
